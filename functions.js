function cotarhapvidaambulatorial(){
    ...
    if(totalPessoas > 0 && valorTotal > 0){
        document.getElementById('resultadoQuantidadeDePessoas').innerHTML = 'Total de pessoas: \t R$' + totalPessoas;
        document.getElementById('resultadoValorFinal').innerHTML = 'Valor total: \tR$' + valorTotal;
    }
}
